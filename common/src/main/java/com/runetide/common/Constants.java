...
public class Constants {
    ...
    public static final Vector2L REGIONS_PER_SECTOR_VEC = Vector.of(REGIONS_PER_SECTOR_X, REGIONS_PER_SECTOR_Z);
    ...
    public static final Vector2L CHUNKS_PER_REGION_VEC = Vector.of(CHUNKS_PER_REGION_X, CHUNKS_PER_REGION_Z);

    public static final int CHUNK_SECTIONS_PER_CHUNK = 256;
    public static final Vector3L CHUNK_SECTIONS_PER_CHUNK_VEC = Vector.of(1, CHUNK_SECTIONS_PER_CHUNK, 1);
    ...
    public static final Vector3L BLOCKS_PER_CHUNK_SECTION_VEC = Vector.of(BLOCKS_PER_CHUNK_SECTION_X,
    ...
    public static final Vector3L VOXELS_PER_BLOCK_VEC = Vector.of(VOXELS_PER_BLOCK_X, VOXELS_PER_BLOCK_Y,
            VOXELS_PER_BLOCK_Z);
    ...
    public static final Vector3L OFFSETS_PER_VOXEL_VEC = Vector.of(OFFSETS_PER_VOXEL_X, OFFSETS_PER_VOXEL_Y,
            OFFSETS_PER_VOXEL_Z);
