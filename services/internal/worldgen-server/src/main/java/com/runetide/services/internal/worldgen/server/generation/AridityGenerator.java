...
public class AridityGenerator extends DelegatingGenerator2<ColumnRef, long[]> {
    public AridityGenerator(final WorldSeed worldSeed) {
        super(new InterpolatingGenerator2L<>(SectorRef.class, ColumnRef.class, new BicubicInterpolator(),
                new OpenSimplex2SGenerator2L<>(SectorRef.class, ColumnRef.class, worldSeed.sector(SeedPurpose.ARIDITY),
